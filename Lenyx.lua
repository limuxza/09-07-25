...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        local function SelectTab()
            ...
            if TabIcon then
                TabIcon.ImageColor3 = Color3.fromRGB(138, 43, 226)
    ...
    task.spawn(function()
        ...
        if DefaultTab and Tabs[DefaultTab] then
            ...
            if defaultTab.Icon then
                defaultTab.Icon.ImageColor3 = Color3.fromRGB(138, 43, 226)
                defaultTab.Icon.ImageTransparency = 0
            end
        ...
        elseif tabOrder > 0 then
            ...
            if firstTab then
                ...
                if firstTab.Icon then
                    firstTab.Icon.ImageColor3 = Color3.fromRGB(138, 43, 226)
                    firstTab.Icon.ImageTransparency = 0
                end
    ...
    if config.ConfigSave ~= false then
        ...
        Icon = "rbxassetid://10709812485",       TextColor = Color3.fromRGB(255, 255, 255)})
